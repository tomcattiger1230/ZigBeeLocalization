...
typedef struct LocalizationParameter{
  float A[4];
  float n[4];      
  float Zhigh;   // mission high
}LParameter;
...
#define SAMPLEAPP_TEST_ENDPOINT      30
...
#define RSSI_AVG_WINDOW_SIZE     32  //size of RSSI moving average 32


// Send Message Timeout
#define SAMPLEAPP_SEND_PERIODIC_MSG_TIMEOUT   30     // Every 3 seconds ==3000 now is 50ms
#define SAMPLEAPP_SEND_PERIODIC_TESTER        100
...
#define SAMPLEAPP_SEND_PERIODIC_TESTER_EVT    0x0003
  
// Group ID for Command
